  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected: '[&>.rdp-day_button]:!bg-blue-600 [&>.rdp-day_button]:!text-white [&>.rdp-day_button]:font-semibold',
        today: '[&>.rdp-day_button]:border [&>.rdp-day_button]:border-blue-500/50 [&>.rdp-day_button]:text-blue-400',
